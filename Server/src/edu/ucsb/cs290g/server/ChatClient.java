...
public class ChatClient {
	...
	public ChatClient(int port) {
		...
		try {
			...
			//Sending username
			send = new Message(user.getBytes(), contact.getBytes(), msg.getBytes(), msg.getBytes(),109);
			sendAndRecieve(send);
			...
			while(true){
				...
				try{
					...
					System.out.println(response.getSFrom() + ":" + msg);
	...
	public static void main(String[] args) {
		...
		ChatClient me = new ChatClient(12345);
